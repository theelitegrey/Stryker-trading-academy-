  ...
  'privacy': {
    ...
    bodyHtml:
      ...
      '<ul>' +
        ...
        '<li><strong>Meta (Facebook/Instagram) advertising</strong> — if and when we enable Meta Pixel / Conversions API, Meta may set advertising cookies and receive hashed identifiers (never your raw email) to measure ad performance; this is off by default and only applies once enabled.</li>' +
